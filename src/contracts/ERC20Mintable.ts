export default {
  ...
  ast: {
    ...
    nodes: [
      ...
      {
        absolutePath:
          '/home/nventuro/dev/openzeppelin-solidity/contracts/token/ERC20/ERC20.sol',
        file: './ERC20.sol',
        id: 8331,
      ...
      {
        absolutePath:
          '/home/nventuro/dev/openzeppelin-solidity/contracts/access/roles/MinterRole.sol',
